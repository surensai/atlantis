...
angular.module('app').factory('AuthenticationService', ['$http', '$cookieStore', '$rootScope', '$timeout', 'UserService', '$remember' ,function ($http, $cookieStore, $rootScope, $timeout, UserService, $remember) {
